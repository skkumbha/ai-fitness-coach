...
echo "🔧 Updating Nginx configuration to proxy API calls to backend on port 8081..."

# Create the updated Nginx configuration with API proxy
...
if sudo nginx -t; then
    ...
    echo "🔌 API calls will be proxied to backend on port 8081"
    echo ""
    echo "📝 Next steps:"
    echo "1. Deploy your Spring Boot backend on port 8081"
    echo "2. Test API calls from the frontend"
else
